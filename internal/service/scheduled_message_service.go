...
func NewScheduledMessageService(schedRepo repository.ScheduledMessageRepository, messageRepo repository.MessageRepository, chatRepo repository.ChatRepository) ScheduledMessageService {
	return &scheduledMessageService{schedRepo: schedRepo, messageRepo: messageRepo, chatRepo: chatRepo}
}

func (s *scheduledMessageService) Schedule(userID string, req *domain.ScheduleMessageRequest) (*domain.ScheduledMessage, error) {
...
func (s *scheduledMessageService) GetScheduled(userID string) ([]*domain.ScheduledMessage, error) {
