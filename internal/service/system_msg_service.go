...
func (s *systemMessageService) createSystemMessage(chatID, senderID string, content domain.SystemMessageContent) {
	now := time.Now()
...
func (s *systemMessageService) NotifyUserJoined(chatID, userID, userName string) {
	s.createSystemMessage(chatID, userID, domain.SystemMessageContent{
		Action:   domain.SysUserJoined,
		UserID:   userID,
		UserName: userName,
	})
}
...
func (s *systemMessageService) NotifyUserRemoved(chatID, userID, userName, byUserID, byUserName string) {
	s.createSystemMessage(chatID, byUserID, domain.SystemMessageContent{
		Action:     domain.SysUserRemoved,
		UserID:     byUserID,
		UserName:   byUserName,
		TargetID:   userID,
		TargetName: userName,
...
func (s *systemMessageService) NotifyChatPhotoChanged(chatID, userID, userName string) {
	s.createSystemMessage(chatID, userID, domain.SystemMessageContent{
		Action:   domain.SysChatPhotoChanged,
		UserID:   userID,
		UserName: userName,
	})
}
...
func (s *systemMessageService) NotifyMessagePinned(chatID, userID, userName string) {
	s.createSystemMessage(chatID, userID, domain.SystemMessageContent{
		Action:   domain.SysMessagePinned,
		UserID:   userID,
		UserName: userName,
	})
}
...
func (s *systemMessageService) NotifyMessageUnpinned(chatID, userID, userName string) {
	s.createSystemMessage(chatID, userID, domain.SystemMessageContent{
		Action:   domain.SysMessageUnpinned,
		UserID:   userID,
		UserName: userName,
	})
}
